...
contract TestTask2 {
    ...
    function provideLiquidity(
...

        {
            ...
            if (amount0 == 0) {
                (sqrtPAX96, sqrtPBX96) = computeBordersForFullToken1Asset(
                    width,
                    sqrtPriceX96
                );
            } else if (amount1 == 0) {
                (sqrtPAX96, sqrtPBX96) = computeBordersForFullToken0Asset(
                    width,
                    sqrtPriceX96
                );
            } else {
                (sqrtPAX96, sqrtPBX96) = computeBordersForGeneralCase(
                    width,
                    amount0,
                    amount1,
                    sqrtPriceX96
    ...
    function computeBordersForGeneralCase(
        ...
        uint256 sqrtPAX96Numerator = computeSqrtPAX96Numerator(
            width,
            amount0,
            amount1,
            sqrtPriceX96
